...
function setItem(){
  let stringifyItems = JSON.stringify(allProducts);
  localStorage.setItem('local-storage', stringifyItems);
}

function getItem(){
  let potentItem = localStorage.getItem('local-storage');
  if (potentItem){
    let parsedItem = JSON.parse(potentItem);
